...
/*
Given an array,
find the sub-array (containing at least k numbers)
...
import java.util.*;
import java.io.*;
public class Largest_Sum_Subarray_K_Numbers {
    ...
    static class FastScanner {
        ...
        /**
         * The default size of the FastReader's buffer is 2<sup>16</sup>.
         */
        private static final int DEFAULT_BUFFER_SIZE = 1 << 16;

        /**
         * The default stream for the FastReader is standard input.
         */
        ...
        /**
         * Create an FastReader that reads from standard input.
         */
        public FastScanner() {
